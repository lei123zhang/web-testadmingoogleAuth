  ...
  export default {
    ...
    methods: {
			searchByFilter() {
				...
				let bol = this.filterSearch.minBalance > this.filterSearch.maxBalance ||
				this.filterSearch.minFrozenBalance > this.filterSearch.maxFrozenBalance ||
				this.filterSearch.minAllBalance > this.filterSearch.maxAllBalance;
				
				if(bol) {
					this.$Message.warning('最低币数不能大于最高币数');l
				}else{
