  ...
  <Modal
		...
		<Form :model="coinForm" :label-width="80" class='form'>
			...
			<Row>
				<Col span="8">
					<FormItem label="充值">
						<i-switch v-model="coinForm.canRecharge" :true-value="0" :false-value="1" size="large">
				...
				<Col span="8">
					<FormItem label="RPC">
						<i-switch v-model="coinForm.enableRpc" :true-value="0" :false-value="1" size="large">
							<span slot="open">开放</span>
							<span slot="close">禁止</span>
						</i-switch>
					</FormItem>
				...
				<Col span="8">
					<FormItem label="提现">
						<i-switch v-model="coinForm.canWithdraw" :true-value="0" :false-value="1" size="large">
				...
				<Row>
					<Col span="12">
						<FormItem label="自动转账">
							<i-switch v-model="coinForm.canAutoWithdraw" :true-value="0" :false-value="1"  size="large">
								<span slot="open">启用</span>
								<span slot="close">禁用</span>
							</i-switch>
						</FormItem>
	...
	<Modal
		...
		width="380"
		>
		<Form :model="coldWalletForm" :label-width="100" :rules="coldWalletRule">
			<FormItem label="币种：">
			...
			<FormItem label="谷歌验证码：" prop="code" v-show="needCord">
