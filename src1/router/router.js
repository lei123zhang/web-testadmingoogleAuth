...
export const otherRouter = {
  ...
  children: [
    ...
    { path: '/recommend/member/commissiondetail', title: '推荐详情', name: 'recommend:member:commissiondetail', component: resolve => { require(['@/views/recommend/MemberDetail.vue'], resolve) } },
...
let findSlideArr = [
  ...
  { id: 143, path: '/recommend', icon: 'folder', component: Main },
  { id: 162, path: '/activity', icon: 'folder', component: Main },
	{ id: 177, path: '/businessAuth', icon: 'folder', component: Main },
  { id: 188, path: '/googleauth', icon: 'clipboard', component: Main },
  ...
  { id: 117, path: 'auditvote', icon: 'clipboard', component: resolve => { require(['@/views/system/Vote.vue'], resolve) } },
  { id: 123, path: 'transaddress', icon: 'clipboard', component: resolve => { require(['@/views/system/TransferAddress.vue'], resolve) } },
  { id: 140, path: 'rechargemanage', icon: 'clipboard', component: resolve => { require(['@/views/otc/RechargeManage.vue'], resolve) } },
  { id: 141, path: 'withdrawalsmanage', icon: 'clipboard', component: resolve => { require(['@/views/otc/WithdrawalsManage.vue'], resolve) } },
  { id: 128, path: 'dividend', icon: 'clipboard', component: resolve => { require(['@/views/system/Dividend.vue'], resolve) } },
  { id: 135, path: 'authentication', icon: 'clipboard', component: resolve => { require(['@/views/system/Authentication.vue'], resolve) } },
  { id: 138, path: 'member', icon: 'clipboard', component: resolve => { require(['@/views/recommend/Member.vue'], resolve) } },
  { id: 146, path: 'commissionparam', icon: 'clipboard', component: resolve => { require(['@/views/recommend/CommissionParam.vue'], resolve) } },
  ...
  { id: 167, path: 'activity', icon: 'clipboard', component: resolve => { require(['@/views/activity/Activity.vue'], resolve) } },
  { id: 170, path: 'signrecord', icon: 'clipboard', component: resolve => { require(['@/views/activity/SignRecord.vue'], resolve) } },
  { id: 171, path: 'statistic', icon: 'clipboard', component: resolve => { require(['@/views/finance/FinanceStatistic.vue'], resolve) } },
	...
	{ id: 189, path: 'manage', icon: 'clipboard', component: resolve => { require(['@/views/googleAuth/googleAuth.vue'], resolve) } },
