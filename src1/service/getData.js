...
//POST获取 "首页" => "币币统计表"
export const allExchangeCoin = data => post('admin/index/statistics/all-exchange-coin', data);

//POST获取 "首页" => "待办事项"
export const backlog = data => fetch('admin/index/statistics/affairs');
...
//POST获取 "首页" => "谷歌验证"=>"登录"
export const googleAuthLogin = data => post('admin/system/employee/googleAuth/sign/in', data);

//POST获取 "首页" => "谷歌验证"=>"登录"=>"only"
export const onlyGoogleLogin = data => post('admin/system/employee/googleAuth', data);

//POST获取 "首页" => "是否绑定谷歌验证"
export const ifBindGoogleAuth = data => post('admin/google/yzgoogle', data);

//GET获取 "谷歌验证" => "获取谷歌验证码"
export const sendGoogle = () => fetch('admin/google/sendgoogle');

//GET获取 "谷歌验证" => "绑定谷歌验证码"
export const bindGoogle = data => post('admin/google/googleAuth', data);

//GET获取 "谷歌验证" => "绑定谷歌验证码"
export const unbindGoogle = data => post('admin/google/jcgoogle',data);

//GET获取 "谷歌验证" => "判断是否绑定谷歌验证码"
export const googleState = () => fetch('admin/google/googleState');